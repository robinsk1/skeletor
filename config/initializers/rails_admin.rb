# RailsAdmin config file. Generated on May 26, 2013 17:33
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Skeletor', 'Admin']
  ...
  # config.excluded_models = ['Appearance', 'Artist', 'Edition', 'Festival', 'Location', 'Picture', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Appearance', 'Artist', 'Edition', 'Festival', 'Location', 'Picture', 'Role', 'User']
  ...
  # config.model 'Appearance' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your appearance.rb model definition
  ...
  #     configure :appearances, :has_many_association 
  #     configure :pictures, :has_many_association 
  #     configure :location, :has_one_association 
  #     configure :editions, :has_many_association 
  #     configure :roles, :has_many_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :musicbrainz_id, :string 
  ...
  #     configure :festival, :belongs_to_association 
  #     configure :appearances, :has_many_association 
  #     configure :location, :has_one_association 
  ...
  #     configure :id, :integer 
  #     configure :festival_id, :integer         # Hidden 
  #     configure :start_date, :datetime 
  #     configure :end_date, :datetime 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :web, :string 
  #     configure :line_up_url, :string 
  #     configure :css_element, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your festival.rb model definition

  #   # Found associations:

  #     configure :artists, :has_and_belongs_to_many_association 
  #     configure :editions, :has_many_association 
  #     configure :pictures, :has_many_association 
  #     configure :roles, :has_many_association 
  ...
  #     configure :locationable, :polymorphic_association 
  #     configure :roles, :has_many_association 
  ...
  #     configure :locationable_id, :integer         # Hidden 
  #     configure :locationable_type, :string         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :cover_image_name, :string         # Hidden 
  #     configure :cover_image_uid, :string         # Hidden 
  #     configure :cover_image, :dragonfly 
